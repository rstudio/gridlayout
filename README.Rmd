...
A package to making building dashboard-style layouts in Shiny and RMarkdown easy using CSS-Grid.
...
For more info and alternative ways of defining a layout see `vignette("Defining a layout")`.
