...
#' @param container_id Unique id for the layout container. This needs to be unique so
...
#'    e.g. `#grid_page__nested_panel__grid_container`.
#' @inheritDotParams grid_container
#'
...
nested_grid_panel <- function(
  ...
  if (using_default_id) container_id <- "nested-grid-placeholder"
  ...
  if(using_default_id) {
    container$attribs$placeholder_id <- TRUE
  }
