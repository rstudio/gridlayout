...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"grid-helpers.ts":[function(require,module,exports) {
"use strict"; // Functions related to grid construction

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sizes_to_template_def = exports.set_element_in_grid = exports.make_template_start_end = void 0; // Builds the start/end css string for a grid-{row,column}

function make_template_start_end(_a) {
  var start = _a[0],
      end = _a[1]; // If we only have a single value just assume we take up one row
...
},{}],"maybe_make_el.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.remove_elements = exports.maybe_make_el = void 0;

var grid_helpers_1 = require("./grid-helpers"); // This is a heavy-lifter that takes care of building elements and placing them
...
function maybe_make_el(parent, sel_txt, _a) {
  var _b = _a === void 0 ? {} : _a,
      event_listener = _b.event_listener,
      styles = _b.styles,
      innerHTML = _b.innerHTML,
      data_props = _b.data_props,
      grid_rows = _b.grid_rows,
      grid_cols = _b.grid_cols,
      props = _b.props;
  ...
  if (grid_rows) {
    el.style.gridRow = grid_helpers_1.make_template_start_end(grid_rows);
  }

  if (grid_cols) {
    el.style.gridColumn = grid_helpers_1.make_template_start_end(grid_cols);
  }

  return el;
}

exports.maybe_make_el = maybe_make_el; // Given a list of elements from a query selector, remove them all
...
},{"./grid-helpers":"grid-helpers.ts"}],"draw_browser_header.ts":[function(require,module,exports) {
"use strict";
...
function draw_browser_header() {
  ...
  var url_address = index_1.shiny_exists ? "www.myShinyApp.com" : "www.myGridApp.com";
...
},{"./maybe_make_el":"maybe_make_el.ts"}],"focused_modal.ts":[function(require,module,exports) {
"use strict";
...
function focused_modal(_a) {
  var background_callbacks = _a.background_callbacks,
      modal_contents = _a.modal_contents,
      modal_callbacks = _a.modal_callbacks;
  var background = maybe_make_el_1.maybe_make_el(document.querySelector("body"), "div.background-blurrer", {
    event_listener: background_callbacks
  });
  return {
    background: background,
    modal: maybe_make_el_1.maybe_make_el(background, "div.modal", {
...
},{"./maybe_make_el":"maybe_make_el.ts"}],"make_css_unit_input.ts":[function(require,module,exports) {
"use strict";
...
},{"./maybe_make_el":"maybe_make_el.ts","./index":"index.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
},{"./maybe_make_el":"maybe_make_el.ts","./draw_browser_header":"draw_browser_header.ts","./make_incrementer":"make_incrementer.ts","./focused_modal":"focused_modal.ts","./make_css_unit_input":"make_css_unit_input.ts","./grid-helpers":"grid-helpers.ts"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
