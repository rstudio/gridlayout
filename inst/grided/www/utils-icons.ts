export const verticalDragIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M21 11H3V9H21V11M21 13H3V15H21V13Z" />
</svg>`;

export const horizontalDragIcon = `<svg style="width:24px;height:24px;max-height:100%;" viewBox="0 0 24 24">
<path fill="currentColor" d="M11 21H9V3H11V21M15 3H13V21H15V3Z" />
</svg>`;

export const trashcanIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z" />
</svg>`;

export const bottomRightArrow = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M5,6.41L6.41,5L17,15.59V9H19V19H9V17H15.59L5,6.41Z" />
</svg>`;

export const seArrow = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M5,6.41L6.41,5L17,15.59V9H19V19H9V17H15.59L5,6.41Z" />
</svg>`;

export const nwArrow = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M19,17.59L17.59,19L7,8.41V15H5V5H15V7H8.41L19,17.59Z" />
</svg>`;

export const topLeftArrow = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M5,6.41L6.41,5L17,15.59V9H19V19H9V17H15.59L5,6.41Z" />
</svg>`;

export const dragIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export const plusIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z" />
</svg>`;

export const minusIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
<path fill="currentColor" d="M19,13H5V11H19V13Z" />
</svg>`;

export const settingsIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export const instructionsIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export const elementsIcon = `<svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
export const clipboardIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
