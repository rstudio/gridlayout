    ...
    Output
      <div class="container-fluid">
        <div id="grid_page" class="grid-container">
          <div class="grid_panel panel-content gridlayout-card" style="justify-content: stretch; align-content: stretch;" id="grid_page__header">
            <h2 id="header">This is my header content</h2>
          </div>
          <div class="grid_panel panel-content gridlayout-card" style="justify-content: stretch; align-content: stretch;" id="grid_page__footer">
          ...
          <div class="grid_panel panel-content gridlayout-card" style="justify-content: stretch; align-content: stretch;" id="grid_page__plot">
