...
## Adding extra styles to elements

The elements can be additionally styled with any arbitrary styles you want via the `element_styles` argument. Here we give every element the background of "honeydew". 
